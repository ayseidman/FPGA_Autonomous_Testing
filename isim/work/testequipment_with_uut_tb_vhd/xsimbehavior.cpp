...
#include "C:/Xilinx92i/vhdl/hdp/nt/ieee/math_real/math_real.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_testequipment_with_uut_tb_vhd_behavior(const char*);
        topvh = createWork_testequipment_with_uut_tb_vhd_behavior("TestEquipment_with_UUT_TB_vhd");
...
main(int argc, char **argv) {
  ...
  try {
    ...
    IeeeMath_real=new Ieee_math_real("MATH_REAL");
