...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_testvectorgenerator_tb_vhd_behavior(const char*);
        topvh = createWork_testvectorgenerator_tb_vhd_behavior("TestVectorGenerator_TB_vhd");
